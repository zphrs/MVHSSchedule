function getDateFromYearMonthWeekDay(year: number, month: number, week: number, day: number): Date {
...
export function fromStr(day : Date, str : string) {
    ...
    const [hour, minute] = [Number.parseInt(str.slice(0, 2)), Number.parseInt(str.slice(2, 4))];
